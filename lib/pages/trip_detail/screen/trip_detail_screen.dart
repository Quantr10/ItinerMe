...
import 'package:itinerme/pages/trip_detail/screen/destination_card.dart';
import 'dart:convert';
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () => setState(() => selectedUrl = url),
                          child: Stack(
                            children: [
                              ClipRRect(
                              ...
                              : () async {
                                try {
                                  ...
                                  await FirebaseFirestore.instance
                                      .collection('trips')
                                      .doc(widget.trip.id)
                                      .update({'coverImageUrl': selectedUrl});

                                  setState(() {
                                    widget.trip.coverImageUrl = selectedUrl!;
                                  });
