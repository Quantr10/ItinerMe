...
import 'package:itinerme/models/trip.dart';
import 'package:itinerme/theme/app_theme.dart';
                ...
                Row(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child:
                          destination.photoReference != null
                              ? Image.network(
                                'https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${destination.photoReference}&key=${dotenv.env['GOOGLE_MAPS_API_KEY']}',
                                width: 120,
                                height: 120,
                                fit: BoxFit.cover,
                              )
